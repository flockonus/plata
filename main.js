// Based on https://labs.phaser.io/edit.html?src=src\game%20objects\tilemap\collision\matter%20platformer%20with%20wall%20jumping.js
...
// holds `this` upon creation for investigation
var scene;
...
function preload ()
{
    ...
    this.load.setBaseURL('http://localhost:8000/node_modules/phaser3-examples/public');
...
function create ()
{
    ...
    this.input.keyboard.on('keydown_C', function (ev) {
...
function updateText ()
{
    text.setText([
        ...
        `\tplayer msSpeed: ${smoothedControls.msSpeed}`,
        `\tplayer value: ${smoothedControls.value}`,
    ]);
}
